...
const TRANSLATIONS = {
  en: {
    ...
    session_lapsed: '⚠ Session expired — tap to sign in again, or records will not load',
  ...
  ms: {
    ...
    session_lapsed: '⚠ Sesi tamat — ketik untuk log masuk semula, jika tidak rekod tidak akan dimuatkan',
    ...
    ask_nursery:      'Tapak semaian mana anda audit hari ini?',
    pre_nursery:      'Tapak Semaian Kecil',
    main_nursery:     'Tapak Semaian Besar',
    enter:            'Masuk',
    switch_note:      'Anda boleh tukar tapak semaian bila-bila masa dari menu audit.',
